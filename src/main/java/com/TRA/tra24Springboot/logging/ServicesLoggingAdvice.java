...
public class ServicesLoggingAdvice {
    public static Logger logger = LoggerFactory.getLogger(ServicesLoggingAdvice.class);


    @Pointcut(value = "execution(* com.TRA.tra24Springboot.*.*(..))")
